        ...
        <div className="space-y-8 p-8">
            ...
            <div className="grid gap-6 md:grid-cols-4">
                {[
                    ...
                    { label: "Active Campaigns", value: campaigns.filter(c => (c.status as string) === "Active").length.toString(), icon: Clock, color: "text-orange-600", bg: "bg-orange-500/5" },
                ].map((stat) => (
                        ...
                        <TableBody>
                            {filteredCampaigns.map((campaign) => (
                                ...
                                >
                                    ...
                                    <TableCell className="py-6">
                                        <Badge variant={(campaign.status as string) === "Active" ? "default" : campaign.status === "Completed" ? "secondary" : "outline"} className={cn(
                                            "rounded-full px-4 py-1 text-[10px] font-bold uppercase tracking-widest",
                                            (campaign.status as string) === "Active" ? "bg-primary shadow-lg shadow-primary/20" : "bg-muted text-muted-foreground"
                                        )}>
                                            {campaign.status}
                                        </Badge>
                                    </TableCell>
